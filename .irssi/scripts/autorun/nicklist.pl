...
Irssi::settings_add_str('nicklist', 'nicklist_prefix_mode_owner', '\e[33m~\e[39m');
Irssi::settings_add_str('nicklist', 'nicklist_prefix_mode_op', '\e[33m@\e[39m');
Irssi::settings_add_str('nicklist', 'nicklist_prefix_mode_halfop', '\e[34m%\e[39m');
Irssi::settings_add_str('nicklist', 'nicklist_prefix_mode_voice', '\e[32m+\e[39m');
